...
export const WrappedRedisClient: new (options: ClientOpts) => WrappedRedisClient;

export interface WrappedRedisClient extends Commands<Promise<any>>, EventEmitter {
    connected: boolean;
    ...
    duplicate(options?: ClientOpts, cb?: Callback<WrappedRedisClient>): WrappedRedisClient;
...
export function createClient(port: number, host?: string, options?: ClientOpts): WrappedRedisClient;
export function createClient(unix_socket: string, options?: ClientOpts): WrappedRedisClient;
export function createClient(redis_url: string, options?: ClientOpts): WrappedRedisClient;
export function createClient(options?: ClientOpts): WrappedRedisClient;
